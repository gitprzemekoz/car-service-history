...
1. **What is the expected request rate (qps) and data volume?** — Owner: user. By: before tech-stack selection. Not captured during shaping; only `target_scale.users: small` was determined.
